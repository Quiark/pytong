...
class Frame(wx.Frame):
	...
	def __init__(self, title):
		...
		self.IM_OK = self.imageList.Add(wx.Bitmap(ICON_OK, wx.BITMAP_TYPE_PNG))
		self.IM_NOK = self.imageList.Add(wx.Bitmap(ICON_NOK))
		self.IM_DEFAULT = self.imageList.Add(wx.Bitmap(ICON_DEFAULT))
	...
	def Load(self):
		...
		if suite._tests == []:
			wx.MessageBox("No tests could be loaded from this module.", "No tests found", wx.ICON_ERROR)
			return
